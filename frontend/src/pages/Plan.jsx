...
const SESSIONS = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Cable Lateral Raise (or DB lateral raise)', sets: '3', reps: '12–15 (RIR 1)', rest: '60 sec', subs: ['DB Lateral Raise', 'Incline Dumbbell Y Raise', 'Machine Lateral Raise'] },
      { name: 'Cable Face Pull', sets: '3', reps: '12–15 (RIR 1)', rest: '60 sec', subs: ['Rear Delt Fly', 'Reverse Cable Crossover', 'Lying DB Reverse Fly'] },
      { name: 'Tricep Bar Pushdown', sets: '3', reps: '10–12 (RIR 1)', rest: '60 sec', subs: ['Tricep Rope Pushdown', 'Band Tricep Pushdown'] },
      { name: 'Incline DB Curl', sets: '3', reps: '10–12 (RIR 1)', rest: '60 sec' },
      { name: 'Cable Overhead Tricep Extension (or DB)', sets: '2', reps: '10–12 (RIR 1)', rest: '60 sec', subs: ['DB Overhead Tricep Extension'] },
      { name: 'Hammer Curl', sets: '2', reps: '10–12 (RIR 1)', rest: '60 sec', subs: ['Cross-Body Hammer Curl'] },
    ],
    notes: [
